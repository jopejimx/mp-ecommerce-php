...
$item->picture_url = 'https://jopejimx-mp-ecommerce-php.herokuapp.com/assets/' . str_replace('./assets/', '', $_POST['img']);
$item->quantity =  $_POST['unit'];
$item->unit_price =  $_POST['price'];
$preference->items = array($item);
$excluded_payment_met = new stdClass();
$excluded_payment_met ->id = 'amex';
$excluded_payment_ty = new stdClass();
$excluded_payment_ty ->id = 'atm';
$pay = new stdClass();
$pay->installments = 6;
$pay->excluded_payment_methods = array($excluded_payment_met);
$pay->excluded_payment_types = array($excluded_payment_ty);
$pay->default_installments = 6;
$preference->payment_methods = $pay;
// $preference->external_reference = 'jopeji@gmail.com';
...
// $preference->payment_methods->default_installments = 6;
...
// $payment->excluded_payment_types = array('atm');
// $payment->installments = 6;
// $payment->default_installments = 6;
// $preference->payment_methods = $payment;
// $preference->payment_methods->excluded_payment_methods = array('amex', 'bancomer', 'serfin', 'banamex');
// $preference->payment_methods->installments = 6;
// $preference->payment_methods->default_installments = 6;
$preference->back_urls = array('success'=> $_SERVER['SERVER_NAME'] . '/success.php', 'pending'=> $_SERVER['SERVER_NAME'] . '/pending.php', 'failure'=>$_SERVER['SERVER_NAME'] . '/failure.php');
...
$payer->address = array("zip_code"=> '1111' , "street_number" => 123, 'street_name'=> 'Falsa' );
